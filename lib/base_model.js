...
class BaseModel {
  ...
  constructor() {
    ...
    (0, _defineProperty2.default)(this, "lastSetRequestId", null);
    let {
      modelJson,
      topLevelJson,
      requestId
...
(0, _defineProperty2.default)(BaseModel, "attributes", {});
(0, _defineProperty2.default)(BaseModel, "relations", []);
...
*/
(0, _defineProperty2.default)(BaseModel, "get", function (id) {
  var _this$observables;
  let items = (_this$observables = this.observables) === null || _this$observables === void 0 ? void 0 : _this$observables.collection;
...
(0, _defineProperty2.default)(BaseModel, "set", function () {
  let options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
...
(0, _defineProperty2.default)(BaseModel, "remove", function (model) {
...
(0, _defineProperty2.default)(BaseModel, "all", function () {
